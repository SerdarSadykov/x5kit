import {CalendarContextProps, CalendarFreezeRange, CalendarValue} from 'calendar/types';

export const getNewRange = (date: Date, context: CalendarContextProps): CalendarValue => {
  const {value: [rangeStart, rangeEnd], freezeRange} = context;
